...
public class Properties3 {      // key and value are Strings by default
    ...
    //    p.storeToXML(new FileOutputStream("C:/Users/Nikhil/Documents/code/java programs/collections/PropertiesCollection.xml"), "LaptopDetails");
        p.load(new FileInputStream("C:/Users/Nikhil/Documents/code/java programs/collections/PropertiesCollection.txt"));
        System.out.println(p);
